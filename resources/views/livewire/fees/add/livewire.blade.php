    ...
    <div class="col-xs-12">
        <div class="col-md-12">
            ...
            <div class="form-row">
                ...
                <div class="form-group col mt-2 mb-2">
                    <label for="type">{{ trans('fees/fees.type') }}</label>
                    <select class="custom-select my-1 mr-sm-2" id="type" wire:model="type">
                        <option selected>{{ trans('fees/add.choose') }}...</option>
                        <option value="1">{{ trans('fees/fees.type1') }}</option>
                        <option value="2">{{ trans('fees/fees.type2') }}</option>
                        <option value="3">{{ trans('fees/fees.type3') }}</option>
                    </select>
                    @error('type')
